      ...
      <section className="py-16 md:py-24 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed">
            We welcome the opportunity to discuss your research or consulting
            needs. Reach out to start an initial conversation through the
            contact form, or get in touch directly via email or phone.
          </p>
        </div>
      </section>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    <p className="text-sm text-muted-foreground">
                      <strong className="text-foreground">Note:</strong> ACRC
                      aims to respond within 2-3 working days. If your matter is
                      urgent, please indicate this clearly in your message.
                      Providing a phone number is important for timely
                      follow-up.
                    </p>
                  </div>
                  ...
                  {submitted && (
                    <div className="p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg text-green-800 dark:text-green-200 text-sm">
                      Thank you for contacting ACRC. We have received your
                      message and will respond within 2-3 working days.
                    </div>
                  )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Our office is located in South Jakarta. We welcome visitors by
                appointment for in-person meetings and discussions.
              </p>
            ...
            <div className="bg-muted rounded-lg h-72 flex items-center justify-center border border-border">
              <p className="text-muted-foreground text-center px-4">
                Map placeholder
                <br />
                Jl. Tebet Barat Dalam II No.5, South Jakarta
              </p>
            </div>
          </div>
        </div>
