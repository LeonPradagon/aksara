...
const relatedInsights = [
  {
    ...
    excerpt: "Examining the regulatory framework for Indonesia's digital economy sector and its impact on startups.",
    date: "Jan 20, 2025",
    category: "Economy",
    href: "/insights/article-1"
  },
  {
    title: "Investment Climate Reform: Progress and Remaining Challenges",
    excerpt: "Assessment of Indonesia's investment climate reforms and their impact on foreign direct investment flows.",
    date: "Dec 10, 2024",
    category: "Business",
    href: "/insights/article-2"
  },
  {
    title: "State-Owned Enterprise Reform: Strategic Directions",
    excerpt: "Analysis of Indonesia's SOE reform agenda and implications for corporate governance and competitiveness.",
    date: "Nov 25, 2024",
    category: "Economy",
      ...
      <section className="py-16 md:py-24 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed">
            Economic trends, business regulation, and competitiveness factors shaping Indonesia's economic future and business environment.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="font-serif text-4xl font-bold text-foreground mb-6">
                Navigating Indonesia's Economy
              </h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                As Southeast Asia's largest economy, Indonesia presents significant opportunities alongside complex regulatory and market challenges. ACRC provides comprehensive economic analysis to support strategic decision-making.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our economic research covers macroeconomic trends, sectoral analysis, regulatory developments, and the political economy factors that shape business outcomes.
              </p>
            </div>
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {[
                  'Macroeconomic policy and fiscal analysis',
                  'Investment climate and regulatory reform',
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
            Partner with ACRC for expert insights on Indonesia's economic landscape and business environment.
          </p>
