    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-serif text-6xl md:text-7xl font-bold text-foreground mb-6">Our Team</h1>
          <p className="text-xl text-muted-foreground max-w-4xl leading-relaxed">
            ACRC is a compact and focused group of professionals with experience across government, international organisations, political campaigns, and the private sector. Our team combines analytical rigour with practical experience to deliver insights that matter.
          </p>
        </div>
      </section>

      {/* Leadership */}
      <section id="leadership" className="py-16 md:py-24 border-b border-border scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-5xl font-bold text-foreground mb-4">Leadership</h2>
          <p className="text-lg text-muted-foreground mb-12 leading-relaxed max-w-3xl">
            ACRC's leadership team brings decades of combined experience in policy research, government service, and strategic consulting.
          </p>
            ...
            {leadership.map((member, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-serif text-3xl font-bold text-foreground mb-2">{member.name}</h3>
                  <p className="text-primary font-semibold text-lg mb-6">{member.title}</p>
      ...
      <section id="researchers" className="py-16 md:py-24 border-b border-border bg-muted/30 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-5xl font-bold text-foreground mb-4">Researchers & Consultants</h2>
          <p className="text-lg text-muted-foreground mb-12 leading-relaxed max-w-3xl">
            Our research and consulting team is organised by areas of expertise, combining academic training with practical policy and industry experience.
          </p>

          <div className="space-y-10">
            {researchersByExpertise.map((group) => (
              <div key={group.expertise} className="p-6 rounded-lg border border-border bg-card">
      ...
      {/* Advisory Board */}
      <section id="advisory" className="py-16 md:py-24 border-b border-border scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-5xl font-bold text-foreground mb-4">Advisory Board</h2>
...
communications. They provide strategic guidance on the firm’s direction and 
the quality of its outputs.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {advisoryBoard.map((member) => (
              <div key={member.name} className="p-6 rounded-lg border border-border bg-card hover:shadow-md transition-shadow">
      ...
      <section className="py-16 md:py-24 border-b border-border bg-muted/30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">Work With Us</h2>
          <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
            Connect with our team to discuss your research, policy, or strategic consulting needs.
          </p>
          <Link
            href="/contact"
